...
OpenSpending.identifier = '2013_template_budget';
...
OpenSpending.Styles.Cofog = {
  ...
  '3-3': { icon: 'icons/family.svg', color: '#138EC0', bcolor: '#4E6D00' },
  '3-4': { icon: 'icons/family.svg', color: '#138EC0', bcolor: '#4E6D00' },
  ...
  '6-1': { icon: 'icons/forest.svg', color: '#138EC0', bcolor: '#EC2406' },
  ...
  '8-3': { icon: 'icons/coal.svg', color: '#138EC0', bcolor: '#C75746' },
  '8-4': { icon: 'icons/coal.svg', color: '#138EC0', bcolor: '#C75746' },
  '8-5': { icon: 'icons/coal.svg', color: '#138EC0', bcolor: '#C75746' },
  '9': { icon: 'icons/order-safety.svg', color: '#138EC0', bcolor: '#D33673' },//消防費
  '9-1': { icon: 'icons/order-safety.svg', color: '#138EC0', bcolor: '#D33673' },
  '10': { icon: 'icons/schools.svg', color: '#138EC0', bcolor: '#790586' },//教育費
  '10-1': { icon: 'icons/schools.svg', color: '#138EC0', bcolor: '#790586' },
  '10-2': { icon: 'icons/schools.svg', color: '#138EC0', bcolor: '#790586' },
